...
@TemplateId(name = "com.lv.tools.SFTPIntegrationTemplate")
...
public class SFTPIntegrationTemplate extends SimpleIntegrationTemplate {
  ...
  protected IntegrationResponse execute(
    ...
    String csValue = connectedSystemConfiguration.getValue(SFTPConnectedSystem.CS_PROP_KEY);
